...
exports.post=function(req,res){
	...
	connecti.query('select disease from sbcd90.prescription;',function(err,rows,fields){
		...
		res.write("<html><body><form action='/thanks11' method='post'><div style='color:#00FF00' align='center'><font style='background-color:#B0AAAA'>Disease name:</font> <input type='text' title='Enter the disease name from the list to get the list of prescriptions' name='value0'/></div><div style='color:#00FF00' align='center'><input type='submit' value='go'/></div></form></body></html>");
		res.end();
	});
}