...
exports.post=function(req,res){
	...
	req.on('end',function(){
		...
		connecti.connect();
		//check for errors
		var v='insert into sbcd90.medicine values ('+connecti.escape(parseInt(z1))+','+connecti.escape(z2)+','+connecti.escape(z3)+','+connecti.escape(z4)+','+connecti.escape(z5)+','+connecti.escape(z6)+','+connecti.escape(z7)+')';
		connecti.query(v,function(err,rows,fields){
			...
			res.write("<html><body><p align='center' style='color:#00FF00;font-size:16pt'><font style='background-color:B0AAAA'>Thank You for Submiting your medicine...</font></p></body></html>");
